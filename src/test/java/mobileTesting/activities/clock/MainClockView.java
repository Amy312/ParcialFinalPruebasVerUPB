...
import mobileTesting.control.Button;
import mobileTesting.control.Label;
import mobileTesting.control.TextBox;
...
public class MainClockView {
    ...
    public void setNameAlarmLabel(String nameAlarmLabel) {
        this.nameAlarmLabel =
                new Label(By.xpath("//android.widget.TextView[@resource-id=\"com.hihonor.deskclock:id/am_digital\" and contains(@text,\""+nameAlarmLabel+"\")]"));
    }
}
